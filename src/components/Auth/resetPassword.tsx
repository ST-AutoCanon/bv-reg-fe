...
import { setPassword, setUserData,setPasswordChanged,setResetPassword } from "../../features/login/loginSlice";
    ...
    return (
        <>
            {firstTimeLogin  && !passwordCahnge && (idName.role !=='admin' || idName.status !=='active') ?
                ...
                : passwordCahnge &&
                <Modal isOpen={afterChangePasswordIsopen} onClose={afterChangePasswordOnclose} >
                    <ModalOverlay />
                    <ModalContent className='resister-success' maxW={"600px"} borderRadius={'5px'}>
                        <ModalCloseButton color={"#000"} />
                        <ModalBody bg="#fff" >
